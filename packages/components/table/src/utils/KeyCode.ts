const KeyCode = {
  ...
  MAC_FF_META: 224,
  WIN_IME: 229,
  isTextModifyingKeyEvent: function (e: KeyboardEvent) {
    const { keyCode: t } = e
    if ((e.altKey && !e.ctrlKey) || e.metaKey || (t >= KeyCode.F1 && t <= KeyCode.F12)) return false
    switch (t) {
      case KeyCode.ALT:
  ...
  isCharacterKey: function (keyCode: number) {
