 ...
 * @LastEditors: shen
 * @LastEditTime: 2023-12-29 14:56:42
 * @Description: 
-->
<script lang="ts">
...
export default defineComponent({
  ...
  setup(props, { slots, emit }) {
    const megeAlign = computed(() => ({ offset: [0, 13] }))
      ...
      if (shouldOpen.value) {
        return (
          ...
          createBlock(
            ...
            mergeProps(
              {
                ...
                align: megeAlign.value,
              },
              props.tooltipProps,
              {
                open: props.open,
                'overlay-style': !props.allowEnter && {
                  pointerEvents: 'none',
                },
                onOpenChange,
              },
            ...
            {
              title: withCtx(() => [renderSlot(slots, 'title')]),
              default: withCtx(() => [renderSlot(slots, 'default')]),
              _: 3,
            },
            16,
            ['get-popup-container', 'align', 'open', 'overlay-style'],
          )
        )
      }
